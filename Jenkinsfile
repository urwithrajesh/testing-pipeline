...
stage 'Download'
    node {
        ...
        checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: '**']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[name: 'origin', refspec: '+refs/heads/*:refs/remotes/origin/*', url: 'https://github.com/urwithrajesh/testing-pipeline']]]
        }
