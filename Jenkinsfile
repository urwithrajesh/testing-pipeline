...
slackSend baseUrl: 'https://utdigital.slack.com/services/hooks/jenkins-ci/', channel: 'chatops', message: 'Hello !!! from $JOB_NAME', teamDomain: 'utdigital', token: 'a8p3yJ8BdYURLzmorsUyaIaI'
